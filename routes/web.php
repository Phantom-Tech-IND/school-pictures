...
Route::get('/haeufig-gestellte-fragen-faq', [GuestPanelController::class, 'frequentlyAskedQuestions'])->name('frequently-asked-questions');
Route::get('/impressum', [GuestPanelController::class, 'impressum'])->name('impressum');
Route::get('/agb', [GuestPanelController::class, 'generalTermsAndConditions'])->name('general-terms-and-conditions');
