    ...
    <div class="px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <ul role="list"
            ...
            @foreach ($teamMembers as $member)
                @include('components.team-member', ['team' => $member])
            @endforeach
        </ul>
        <blockquote class="relative max-w-lg mx-auto mt-20 text-center">
            <div class="relative z-10">
                <p class="text-xl text-gray-800">
                    <em class="relative">
                        <svg class="absolute text-gray-100 -top-8 -start-8 size-16 sm:h-24 sm:w-24 dark:text-neutral-700"
                        ...
                        <span class="relative z-10 dark:text-white">DURCH UNSERE VIELFALT ENSTEHEN DIE KREATIVSTEN IDEEN
