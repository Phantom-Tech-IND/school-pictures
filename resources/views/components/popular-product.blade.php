<div class="relative p-6 bg-center bg-no-repeat bg-cover md:p-24"
    ...
    <div class="container relative z-10 grid grid-cols-1 gap-4 px-4 py-5 mx-auto mt-auto md:grid-cols-2 md:gap-6 md:px-10 md:py-10 backdrop-blur-md"
        ...
        <div class="grid grid-cols-2 gap-2 max-h-[600px]">
            <div class="grid gap-4 h-[600px] grid-rows-[1fr,2fr,1fr]">
                <img class="object-cover w-full max-h-full min-h-0" src="{{ asset($product['images'][0]) }}"
                    alt="{{ $product['name'] }}">
            ...
            <div class="grid gap-4 h-[600px] grid-rows-[2fr,1fr,2fr]">
                <img class="object-cover object-top w-full max-h-full min-h-0" src="{{ asset($product['images'][3]) }}"
                    alt="{{ $product['name'] }}">
                <img class="object-cover w-full max-h-full min-h-0" src="{{ asset($product['images'][4]) }}"
                    alt="{{ $product['name'] }}">
                <img class="object-cover object-top w-full max-h-full min-h-0" src="{{ asset($product['images'][5]) }}"
                    alt="{{ $product['name'] }}">
            </div>
        </div>
        <div class="py-4 my-auto md:py-12">
