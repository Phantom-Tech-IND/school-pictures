                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            ...
                            <li>
                                <span href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Mo. + Mi.
                                    und Fr. : 13:00 – 17:00</span>
                            </li>
                            <li>
                                <span href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Ausserhalb
                                    der Öffnungszeiten : Termine nach Vereinbarung</span>
                            </li>
                        </ul>
                    </div>
                    <div class="mt-10 md:mt-0">
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li>
                                <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">HÄUFIG
