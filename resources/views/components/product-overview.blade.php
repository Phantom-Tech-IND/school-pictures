<image-gallery-container data-min="3" data-max="5" id="myGallery">
    <div class="bg-white">
        <div class="pt-6">
                ...
                <div class="relative grid grid-cols-3 gap-4 p-4 overflow-y-scroll border-2 border-gray-300 shadow-lg max-h-96 lg:max-h-max lg:h-auto auto-rows-min place-items-center lg:col-span-2 lg:grid-cols-4 xs:grid-cols-4"
                    @foreach ($images as $key => $image)
                        <image-selector container-id="myGallery" alt="Image {{ $key + 1 }}"
                            ...
                            class="w-24 h-24"></image-selector> @endforeach
                    </div>
                </div>
                        ...
                        <div class="mt-6" x-data="{ rating: 4, maxRating: 5, tempRating: null }">
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center gap-2">
                                    <template
                                        x-for="(star, index) in Array.from({ length: maxRating }, (_, i) => i + 1)"
                                        :key="index">
                                ...
                                <a href="#"
                                    class="ml-3 text-sm font-medium text-accent-600 hover:text-accent-500">117
                                    reviews</a>
                            </div>
                        </div>
                        ...
                        <form class="mt-10">
                            ...
                            <div x-data="{ selectedProductId: '{{ $selectedProductId }}' }" class="mt-10">
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="#"
                                        class="text-sm font-medium text-accent-600 hover:text-accent-500">Info
                                        about products</a>
                                </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-6 lg:grid-cols-4 xs:grid-cols-3">
                                        @foreach ($products as $product)
                                            <label
                                                ...
                                                <input type="radio" name="product-choice"
