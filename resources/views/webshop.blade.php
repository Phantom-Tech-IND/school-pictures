                            ...
                            <ul role="list" class="px-2 py-3 font-medium text-gray-900">
                                ...
                                <li>
                                    <a href="{{ route('webshop') }}"
                                        class="block px-2 py-3 capitalize text-lg transition-all duration-300 ease-in-out transform hover:text-accent-800 origin-left hover:scale-110 hover:font-semibold {{ is_null($selectedCategory) ? 'text-accent-600' : '' }}">Show
                                        All</a>
                                </li>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        ...
                        <form class="hidden lg:block">
                            ...
                            <ul role="list"
                                ...
                                <li>
                                    <a href="{{ route('webshop') }}"
                                        class="block px-2 py-3 capitalize hover:text-accent-800 text-lg transition-all duration-300 ease-in-out transform origin-left hover:scale-110 hover:font-semibold {{ is_null($selectedCategory) ? 'text-accent-600' : '' }}">Show
                                        All</a>
                                </li>
                                @foreach ($categories as $category)
                                    <li>
