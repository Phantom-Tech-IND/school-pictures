@extends('layouts.app')
@section('content')
    <div class="max-w-4xl px-4 mx-auto mt-20 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold leading-tight text-gray-900">
            IMPRESSUM
        </h1>

        <div class="mt-6 space-y-6 text-lg text-gray-700">
            <h2 class="text-2xl font-semibold">KONTAKTADRESSE</h2>
            <p>
            ...
            <h2 class="text-2xl font-semibold">VERTRETUNGSBERECHTIGTE PERSONEN</h2>
            <p>Tanja Arnold, Geschäftsinhaberin</p>

            <h2 class="text-2xl font-semibold">HANDELSREGISTEREINTRAG</h2>
            <p>
                Eingetragener Firmenname: ArtLine Fotografie AG<br />
                Nummer: CH-100.3.789.561-6<br />
                Handelsregisteramt: Kanton Luzern
            </p>

            <h2 class="text-2xl font-semibold">MEHRWEHRTSTEUERNUMMER</h2>
            <p>CHE-114.601.198</p>
            ...
            <h2 class="text-2xl font-semibold">HAFTUNG FÜR LINKS</h2>
            <p>Verweise und Links auf Webseiten Dritter liegen ausserhalb unseres Verantwortungsbereichs Es wird jegliche
                ...
                eigene Gefahr des Nutzers oder der Nutzerin.</p>

            <h2 class="text-2xl font-semibold">URHEBERRECHTE</h2>
            <p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf der Website gehören
                ausschliesslich der Firma ArtLine Fotografie AG oder den speziell genannten Rechtsinhabern. Für die
            ...
            <p>
                ...
                vertraulich behandelt und weder an Dritte verkauft noch weiter gegeben.<br />
                <br />
                In enger Zusammenarbeit mit unseren Hosting-Providern bemühen wir uns, die Datenbanken so gut wie möglich
                vor fremden Zugriffen, Verlusten, Missbrauch oder vor Fälschung zu schützen.<br />
                <br />
            ...
            <h2 class="text-2xl font-semibold">DATENSCHUTZERKLÄRUNG FÜR DIE NUTZUNG VON FACEBOOK-PLUGINS (LIKE-BUTTON)</h2>
            <p>
                Auf unseren Seiten sind Plugins des sozialen Netzwerks Facebook, 1601 South California Avenue, Palo Alto, CA
                94304, USA integriert. Die Facebook-Plugins erkennen Sie an dem Facebook-Logo oder dem “Like-Button”
                ...
                Facebook den Besuch unserer Seiten Ihrem Benutzerkonto zuordnen. Wir weisen darauf hin, dass wir als
            ...
            <h2 class="text-2xl font-semibold">DATENSCHUTZERKLÄRUNG FÜR DIE NUTZUNG VON TWITTER</h2>
            <p>
                Auf unseren Seiten sind Funktionen des Dienstes Twitter eingebunden. Diese Funktionen werden angeboten durch
                die Twitter Inc., 795 Folsom St., Suite 600, San Francisco, CA 94107, USA. Durch das Benutzen von Twitter
                und der Funktion “Re-Tweet” werden die von Ihnen besuchten Webseiten mit Ihrem Twitter-Account verknüpft und
                anderen Nutzern bekannt gegeben. Dabei werden u.a. Daten wie IP-Adresse, Browsertyp, aufgerufene Domains,
                besuchte Seiten, Mobilfunkanbieter, Geräte- und Applikations-IDs und Suchbegriffe an Twitter
                übertragen.<br />
                <br />
                Wir weisen darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der übermittelten Daten
                sowie deren Nutzung durch Twitter erhalten. Aufgrund laufender Aktualisierung der Datenschutzerklärung von
                Twitter, weisen wir auf die aktuellste Version unter (http://twitter.com/privacy) hin.<br />
                <br />
                Ihre Datenschutzeinstellungen bei Twitter können Sie in den Konto-Einstellungen unter
                http://twitter.com/account/settings ändern. Bei Fragen wenden Sie sich an privacy@twitter.com.
            </p>

            <h2 class="text-2xl font-semibold">DATENSCHUTZERKLÄRUNG FÜR DIE NUTZUNG VON GOOGLE ADSENSE</h2>
            <p>
                ...
                Beacons (unsichtbare Grafiken). Durch diese Web Beacons können Informationen wie der Besucherverkehr auf
                ...
                werden. Google wird Ihre IP-Adresse jedoch nicht mit anderen von Ihnen gespeicherten Daten
                zusammenführen.<br />
                <br />
            ...
            <h2 class="text-2xl font-semibold">DATENSCHUTZERKLÄRUNG FÜR DIE NUTZUNG VON GOOGLE ANALYTICS</h2>
            <p>
                ...
                Abkommens über den Europäischen Wirtschaftsraum zuvor gekürzt.<br />
                <br />
                ...
                wird nicht mit anderen Daten von Google zusammengeführt.<br />
                <br />
                Sie können die Installation der Cookies durch eine entsprechende Einstellung Ihrer Browser Software
                verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche
                Funktionen dieser Website voll umfänglich nutzen können. Durch die Nutzung dieser Website erklären Sie sich
            ...
            <h2 class="text-2xl font-semibold">DATENSCHUTZERKLÄRUNG FÜR DIE NUTZUNG VON GOOGLE +1</h2>
            <p>
                Mithilfe der Google +1-Schaltfläche können Sie Informationen weltweit veröffentlichen. Über die Google
                +1-Schaltfläche erhalten Sie und andere Nutzer personalisierte Inhalte von Google und dessen Partnern.
                Google speichert sowohl die Information, dass Sie für einen Inhalt +1 gegeben haben, als auch Informationen
                über die Seite, die Sie beim Klicken auf +1 angesehen haben. Ihre +1 können als Hinweise zusammen mit Ihrem
                Profilnamen und Ihrem Foto in Google-Diensten, wie etwa in Suchergebnissen oder in Ihrem Google-Profil, oder
                an anderen Stellen auf Websites und Anzeigen im Internet eingeblendet werden.<br />
                <br />
                ...
                beim Teilen von Inhalten über Ihr Google-Konto verwendet haben. Die Identität Ihres Google-Profils kann
                Nutzern angezeigt werden, die Ihre E-Mail-Adresse kennen oder über andere identifizierende Informationen von
                Ihnen verfügen.<br />
                <br />
                Neben den oben erläuterten Verwendungszwecken werden die von Ihnen bereitgestellten Informationen gemäß den
                geltenden Google-Datenschutzbestimmungen (http://www.google.com/intl/de/policies/privacy/) genutzt. Google
                veröffentlicht möglicherweise zusammengefasste Statistiken über die +1-Aktivitäten der Nutzer bzw. geben
                diese Statistiken an unsere Nutzer und Partner weiter, wie etwa Publisher, Inserenten oder verbundene
                Websites.
            </p>

            <h2 class="text-2xl font-semibold">QUELLE</h2>
            <p>Dieses Impressum wurde am 31.03.2015 mit dem Impressum-Generator http://www.bag.ch/impressum-generator der Firma Brunner AG, Druck und Medien, in Kriens erstellt. Die Brunner AG, Druck und Medien, in Kriens übernimmt keine Haftung.</p>
        </div>
    </div>
@endsection
