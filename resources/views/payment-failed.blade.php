    ...
    <div class="px-4 -mb-8 sm:px-6 lg:px-8">
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('gallery-code') }}"
                class="p-2 transition duration-300 ease-in-out transform border-2 rounded border-accent text-accent hover:bg-accent hover:text-white hover:-translate-y-1 hover:scale-110"
            >
